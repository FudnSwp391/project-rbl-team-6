    ...
    <div className="flex flex-col gap-lg pb-4">
      ...
      <section className="flex justify-between items-end">
        ...
        <div className="flex items-center gap-4">
          ...
          <button type="button" className="bg-primary text-on-primary px-5 py-2.5 rounded-lg font-label-md text-label-md flex items-center gap-2 hover:bg-primary/90 transition-colors shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] h-12" onClick={() => window.location.hash = '#/dashboard/tutors'}>
            ...
            <section className="bg-surface rounded-xl shadow-sm border border-surface-variant w-full lg:w-[70%] flex flex-col h-full overflow-x-auto">
              ...
              <div className="grid grid-cols-7 min-w-[700px] bg-surface-container-lowest rounded-b-xl flex-1">
                {weekDates.map((wd, index) => {
                  ...
                  return (
                    <div key={index} className={`border-r border-surface-variant last:border-0 p-2 flex flex-col gap-2 ${wd.isToday ? 'bg-primary/5' : 'bg-surface'} h-full min-h-[200px]`}>
