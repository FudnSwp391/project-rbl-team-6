    ...
    <div className="flex flex-col gap-lg pb-4">
      ...
      <section className="flex justify-between items-end">
        ...
        <div className="flex items-center gap-4">
          ...
          <button type="button" className="bg-primary text-on-primary px-5 py-2.5 rounded-lg font-label-md text-label-md flex items-center gap-2 hover:bg-primary/90 transition-colors shadow-[0_4px_6px_-1px_rgba(0,0,0,0.05)] h-12" onClick={() => window.location.hash = '#/'}>
