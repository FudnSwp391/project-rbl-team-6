...
const mockTutors = [
  {
    ...
    rating: 4.9,
    subjects: ['Giải Tích', 'Đại Số Tuyến Tính'],
    price: 65,
    featured: true,
  ...
  },
  {
    ...
    rating: 4.8,
    subjects: ['Vật Lý Lượng Tử', 'Toán SAT'],
    price: 55,
    featured: false,
  ...
  },
  {
    ...
    rating: 4.7,
    subjects: ['Hình Học', 'Luyện Thi ACT'],
    price: 45,
    featured: false,
  ...
  },
  {
    ...
    rating: 4.9,
    subjects: ['Toán Kỹ Thuật', 'Giải Tích III'],
    price: 85,
    featured: false,
  ...
  },
  {
    ...
    rating: 4.6,
    subjects: ['Toán Rời Rạc', 'Thuật Toán'],
    price: 50,
    featured: false,
        ...
        <section className="mb-10">
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 flex flex-col md:flex-row gap-4 items-center">
            <div className="relative w-full">
              ...
              <input className="w-full pl-12 pr-4 py-3 rounded-lg border border-[#c4c5d5] focus:outline-none focus:ring-2 focus:ring-[#00288e]/20 focus:border-[#00288e] transition-all text-base" placeholder="Bạn cần hỗ trợ môn học nào?" type="text" defaultValue="Toán Học" />
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24 filter-sidebar max-h-[calc(100vh-120px)] overflow-y-auto">
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  {['Toán Học', 'Vật Lý', 'Khoa Học Máy Tính', 'Văn Học Tiếng Anh'].map((sub, idx) => (
              ...
              {/* Price Range */}
              <div className="mb-8">
                <label className="text-sm font-semibold text-[#5d5f5f] block mb-3">Giá Theo Giờ (USD)</label>
              ...
              {/* Ratings */}
              <div className="mb-8">
                <label className="text-sm font-semibold text-[#5d5f5f] block mb-3">Đánh Giá Tối Thiểu</label>
                <div className="space-y-2">
                  <label className="flex items-center gap-3 cursor-pointer group">
                    ...
                    <div className="flex items-center gap-1 text-[#FFB800]">
                      ...
                      <span className="material-symbols-outlined text-[18px]" style={{fontVariationSettings: "'FILL' 1"}}>star</span>
                      <span className="material-symbols-outlined text-[18px]" style={{fontVariationSettings: "'FILL' 1"}}>star</span>
                      <span className="text-base text-[#444653] ml-1">&amp; Trở Lên</span>
                    </div>
                  </label>
                </div>
              </div>
              ...
              {/* Availability */}
              <div className="mb-8">
                <label className="text-sm font-semibold text-[#5d5f5f] block mb-3">Lịch Trống</label>
                <div className="grid grid-cols-2 gap-2">
                  {['Ngày Thường', 'Cuối Tuần', 'Buổi Sáng', 'Buổi Tối'].map(time => (
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-center mb-6">
              <p className="text-base text-[#444653]">Hiển thị <span className="font-bold text-[#191c1e]">124</span> gia sư được đánh giá cao nhất</p>
              <div className="flex items-center gap-2">
                <span className="text-sm font-semibold text-[#5d5f5f]">Sắp xếp theo:</span>
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      <div className="flex flex-col">
                        <span className="text-xl font-semibold text-[#00288e]">${tutor.price}<span className="text-xs font-normal text-[#5d5f5f]">/giờ</span></span>
                      </div>
